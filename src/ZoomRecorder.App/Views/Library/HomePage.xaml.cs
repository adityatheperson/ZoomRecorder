...
public sealed partial class HomePage : Page
{
        ...
        bool isLoading = false)
    {
        ...
        if (viewModel is not null)
        {
            ...
            NoRecentText.Visibility = viewModel.RecentRecordings.Count == 0 ? Visibility.Visible : Visibility.Collapsed;
            RecentList.Visibility = viewModel.RecentRecordings.Count == 0 ? Visibility.Collapsed : Visibility.Visible;
        }
    }
